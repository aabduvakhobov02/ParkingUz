...
const EndUserScreens = () => {
  ...
  const [parkings] = useState(parkingsSpots);
      ...
      {/* <MapView
        ...
        {parkings.map(parking => (
          <Marker key={`marker-${parking.id}`} coordinate={parking.coordinate}>
            <TouchableWithoutFeedback onPress={() => setIsActive(parking.id)}>
              <View
                style={[
                  styles.marker,
                  styles.shadow,
                ...
                <View style={styles.hours}>
                  ...
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    ...
                    <Dropdown
                      ...
                      defaultValue={`0${hours[item.id]}:00` || '01:00'}
                      dropdownStyle={styles.hoursDropdownStyle}
                      onSelect={(index, value) => handleHours(item.id, value)}
                      renderRow={option => (
                        <Text
                          style={
                            styles.hoursDropdownOption
                          }>{`0${option}:00`}</Text>
                      )}
            ...
            <View style={styles.modalHours}>
              ...
              <View style={styles.modalHoursDropdown}>
                <Dropdown
                  ...
                  options={availableHours}
                  style={styles.hoursDropdown}
                  defaultValue={`0${hours[activeModal.id]}:00` || '01:00'}
                  dropdownStyle={styles.hoursDropdownStyle}
                  onSelect={(index, value) =>
                    handleHours(activeModal.id, value)
                  }
                  renderRow={option => (
                    <Text
                      style={
